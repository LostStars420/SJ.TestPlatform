...
namespace OnllyTs
{
    public class OnllyDef
    {
        ...
        #region DevType 高16位表示硬件主型号

        /// <summary>
        /// 未知
        /// </summary>
        public const System.UInt16 ONLLY_DEVTYPE_UNKNOWN = 0x0000;

        /// <summary>
        /// A系列
        /// </summary>
        public const System.UInt16 ONLLY_DEVTYPE_A = 0x0001;

        /// <summary>
        /// D系列
        /// </summary>
        public const System.UInt16 ONLLY_DEVTYPE_D = 0x0002;

        /// <summary>
        /// F系列
        /// </summary>
        public const System.UInt16 ONLLY_DEVTYPE_F = 0x0003;

        #endregion DevType 高16位表示硬件主型号


        #region DevType 低16位表示硬件子型号
        ...
        #endregion A 系列测试仪型号定义

        #region D系列测试仪型号定义
        /// <summary>
        /// 0x01
        /// </summary>
        public const int ONLLY_DEVTYPE_D430 = 0x0001;
        #endregion D系列测试仪型号定义

        #region F系列测试仪型号定义
        public const int ONLLY_DEVTYPE_F66 = 0x0001;
        #endregion F系列测试仪型号定义


        #endregion DevType 低16位表示硬件子型号

        #endregion 测试仪硬件型号定义

        #region ONLLY 测试仪硬件信息中特性标志定义
        ...
        //bit_11 -> bit_0 (公共特性) 
        //bit_0 : 是否支持直流
        #endregion ONLLY 测试仪硬件信息中特性标志定义


        #region ONLLY Com error define
        ...
        #endregion ONLLY Com error define
